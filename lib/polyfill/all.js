...
goog.provide('shaka.polyfill.installAllExceptFullscreen');
 ...
 * @export
 */
shaka.polyfill.installAllExceptFullscreen = function() {
  for (var i = 0; i < shaka.polyfill.polyfills_.length; ++i) {
    var polyfill = shaka.polyfill.polyfills_[i];
    if (polyfill !== shaka.polyfill.Fullscreen.install) {
      polyfill();
    }
  }
};
